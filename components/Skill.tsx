...
export default function SkillBudge({ skill, directionleft }: Props) {
  return (
    <div className='group relative flex cursor-pointer'>
      <motion.img
        ...
        className=" object-cover w-24 h-24 xl:w-32 xl:h-32 filter group-hover:grayscale transition duration-300 ease-in-out"
